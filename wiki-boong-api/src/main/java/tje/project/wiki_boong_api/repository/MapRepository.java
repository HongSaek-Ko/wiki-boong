...
public interface MapRepository extends JpaRepository<Map, Long> {
    ...
    @Query("SELECT m FROM Map m JOIN FETCH m.shop s LEFT JOIN FETCH m.shop.shopUser su LEFT JOIN FETCH m.shop.shopOwner so " +
            "WHERE s.shopId = :sid " +
...
//    @Query("SELECT m FROM Map m JOIN FETCH m.shop s LEFT JOIN FETCH m.shop.shopUser su WHERE s.certificate = :certificate")
